...
$title = "Menu";
$_SESSION['show_query'] = " WHERE top_category='Tart and Muffin'";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php include("page_modules/aside.php");?>
    ...
    <div id="sort">
        ...
        <p>
            ...
            <a href="category_tartmuffin.php" style="color:#000;border-bottom:1px solid #000">Tart &amp; Muffin</a><span> .</span>
