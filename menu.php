            ...
            <div id="new_menu">
                ...
                <div id="new_menu_big">
                    ...
                    <div id="big_text_wrapper">
                        <h3>Espresso Tornado</h3>
                        <p>Deep flavored espresso cupcake with sprinkle on the top for coffee lovers</p>
                        <div id="user_btn">
                            <a href="product_detail.php?id=3" id="more_btn_big">More</a>
                            <a href="#"><img src="assets/images/icons/wish.png" alt="add  wishlist button" width="15"height="15"class="wish_cart_btn"></a>
                            <a href="page_modules/tmp_cart.php?product_id=3&qty=1"><img src="assets/images/icons/cart_small.png" alt="add cart button" width="15"height="15"class="wish_cart_btn"></a>
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <form action="#">
            ...
            <div>
                ...
                <select name="Calories" id="sort_calorie">
                    <option value="asc_cal">Calories</option>
                    <option value="asc_cal">Ascending Order</option>
                    <option value="desc_cal">Descending Order</option>
                </select>
            </div>
        </form>
        <p>
            <a href="menu.php" style="color:#000;border-bottom:1px solid #000">All bread</a><span> .</span>
            ...
            <a href="category_salad.php">Salad</a><span> .</span>
